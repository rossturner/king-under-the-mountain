...
public class GoalQueueTest {
	...
	public void popNextGoal_returnsPriorityOrder() {
		goalQueue.add(new QueuedGoal(new Goal("first", "i18nDescription", null), NOURISHMENT, WANT_NORMAL, mockClock));
		goalQueue.add(new QueuedGoal(new Goal("other", "i18nDescription", null), NOURISHMENT, WANT_URGENT, mockClock));
		goalQueue.add(new QueuedGoal(new Goal("yet another", "i18nDescription", null), NOURISHMENT, WANT_NORMAL, mockClock));
	...
	public void goalsWithSamePriority_returnedInInsertionOrder() {
		Goal first = new Goal("first", null, null);
		Goal third = new Goal("third", null, null);
		Goal second = new Goal("second", null, null);
	...
	public void goalsWithExpiredTime_areRemoved() {
		...
		Goal first = new Goal("first", null, 1.0);
		Goal second = new Goal("second", null, null);
