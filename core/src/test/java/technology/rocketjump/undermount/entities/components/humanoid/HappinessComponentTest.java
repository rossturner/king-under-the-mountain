...
import static technology.rocketjump.undermount.entities.components.humanoid.HappinessComponent.HappinessModifier.SLEPT_IN_PRIVATE_BEDROOM;
...
public class HappinessComponentTest {
	...
	public void add_modifier_replaces_other() {
		happinessComponent.add(SLEPT_IN_PRIVATE_BEDROOM);

		assertThat(happinessComponent.getNetModifier()).isEqualTo(10);
		assertThat(happinessComponent.currentModifiers()).contains(SLEPT_IN_PRIVATE_BEDROOM);
