...
public enum GameInteractionMode {
	...
	DESIGNATE_ROOFING("roofing", null, mapTile -> mapTile.getRoof().getState().equals(OPEN) && !mapTile.getRoof().isRoofConstructionQueued(), true),
	CANCEL_ROOFING("cancel", null, mapTile -> mapTile.getRoof().getState().equals(OPEN) && mapTile.getRoof().isRoofConstructionQueued(), true),
